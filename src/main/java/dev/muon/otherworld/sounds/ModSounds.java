package dev.muon.otherworld.sounds;

import dev.muon.otherworld.OtherworldOrigins;
...
public class ModSounds {
    ...
    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(OtherworldOrigins.MODID, name)));
    }
